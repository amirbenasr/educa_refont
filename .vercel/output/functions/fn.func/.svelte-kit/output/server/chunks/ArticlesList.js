import { c as create_ssr_component, i as is_promise, n as noop, a as each, e as escape, b as add_attribute } from "./ssr.js";
/* empty css                                           */
class Convert {
  ...
  return `<div class="articles svelte-qrmqwr"><ul class="svelte-qrmqwr">${function(__value) {
    ...
    return function(articles) {
      return ` ${each(articles, (article, i) => {
        return `<li class="svelte-qrmqwr"><a href="${"/en/blog/" + escape(article.id, true)}"><div class="ar ticle"><div class="top-section"><img loading="lazy"${add_attribute("src", article.yoast_head_json.og_image[0]?.url, 0)} alt="" srcset="" class="svelte-qrmqwr"></div> <div class="middle-section"><h3>${escape(article.title?.rendered)}</h3></div> <div class="bottom-section" data-svelte-h="svelte-vw3euu"><span>Know More</span></div> </div></a></li> `;
      })} `;
    }(__value);
  }(promise)}</ul> </div>`;
});
