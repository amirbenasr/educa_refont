...
import { c as create_ssr_component, h as compute_rest_props, j as spread, k as escape_object, l as escape_attribute_value, b as add_attribute, v as validate_component, e as escape$1 } from "../../../../chunks/ssr.js";
...
const Contact = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { name: name2 = "World" } = $$props;
  let { email = "ex@ex.com" } = $$props;
  let { phone = "000000" } = $$props;
  let { message = "ex@ex.com" } = $$props;
  ...
  return `${validate_component(Html, "Html").$$render($$result, { lang: "en" }, {}, {
    default: () => {
      return `${validate_component(Text$2, "Text").$$render($$result, {}, {}, {
        default: () => {
          return `Name : ${escape$1(name2)} ,`;
        }
      })} ${validate_component(Text$2, "Text").$$render($$result, {}, {}, {
        default: () => {
          return `Email : ${escape$1(email)}`;
        }
      })} ${validate_component(Text$2, "Text").$$render($$result, {}, {}, {
        default: () => {
          return `Subject: ${escape$1(message)}`;
        }
      })} ${validate_component(Text$2, "Text").$$render($$result, {}, {}, {
        default: () => {
          return `Phone: ${escape$1(phone)}`;
        }
      })} ${validate_component(Hr, "Hr").$$render($$result, {}, {}, {})} ${validate_component(Button, "Button").$$render($$result, { href: "https://educaus.net/" }, {}, {
        default: () => {
          return `Visit Educa US`;
        }
      })}`;
    }
  })}`;
...
const actions = {
  send: async ({ request }) => {
    ...
    const result = await transporter.sendMail(options2);
    return {
